...
export const DEPARTMENT_DETAILS = {
  'oral-medicine': {
    ...
    faculty: [
      ...
      { name: 'Dr. Monisha R', role: 'Senior Lecturer', focus: 'Maxillofacial Radiology & CBCT', image: '/Dr.-R-MonishaMds.png' },
      ...
      { name: 'Dr. T. Sindhuja', role: 'Senior Lecturer', focus: 'Oral Medicine & Radiology', image: '/Dr.-T-Sindhuja-Mds.png' },
    ],
    infrastructure: [],
    researchSection: {
  ...
  periodontics: {
    ...
    faculty: [
      ...
      { name: 'Dr. Sakshi', role: 'Professor', focus: 'Regenerative periodontology', image: '/sakshi .jpg' },
  ...
  'conservative-dentistry': {
    ...
    faculty: [
      { name: 'Dr. N. Bharath', role: 'Associate Professor & HOD In-charge', focus: 'Aesthetic operative dentistry & micro-endodontics', image: '/bharath .jpg', isHod: true },
      { name: 'Dr. S. Karthikeyan', role: 'Professor & HOD', focus: 'Endodontics & Restorative Dentistry', image: '/Dr-S-Karthikeyan-MDS.png' },
      { name: 'Dr. R. Sujith', role: 'Associate Professor', focus: 'Endodontics & Restorative Dentistry', image: '/Dr-R-Sujith-MDS.png' },
      { name: 'Dr. S. Sathish', role: 'Senior Lecturer', focus: 'Endodontics & Restorative Dentistry', image: '/Dr-S-Sathish-MDS.png' },
      { name: 'Dr. V. Sudhakar', role: 'Associate Professor', focus: 'Endodontics & Restorative Dentistry', image: '/sudhakar.png' },
      { name: 'Dr. S. Purushothaman', role: 'Associate Professor', focus: 'Endodontics & Restorative Dentistry', image: '/purusho.png' },
      { name: 'Dr. S. Saranya', role: 'Senior Lecturer', focus: 'Endodontics & Restorative Dentistry', image: '/saranya.png' },
      ...
      { name: 'Dr. S. Kalaivani', role: 'Professor', focus: 'Endodontics & microdentistry', image: '/Dr.-S-Kalaivani.jpg' },
  ...
  'public-health-dentistry': {
    ...
    faculty: [
      { name: 'Dr. S. Kalaivani', role: 'Associate Professor & HOD', focus: 'Community Dentistry & Field Epidemiology', image: '/Dr.-S-Kalaivani.jpg', isHod: true },
      { name: 'Dr. Manjula Krishnan', role: 'Professor', focus: 'Community programme design' },
