...
import { HOME_SPECIALISTS, SPECIALISTS_HOME } from '@/lib/homeConstants'
      ...
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-end">
          <Reveal>
            <SectionHeading
              align="left"
              eyebrow={SPECIALISTS_HOME.eyebrow}
              title={SPECIALISTS_HOME.title}
              description={SPECIALISTS_HOME.description}
            />
          </Reveal>
          <Reveal delay={0.1}>
              ...
              <article className="group overflow-hidden rounded-[1.5rem] border border-border/70 bg-white transition-all duration-500 hover:-translate-y-2 hover:shadow-brand">
                <div className="relative aspect-[4/5] overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 p-5">
                    ...
                    <p className="mt-1 text-sm text-white/75">{doctor.specialty}</p>
                  </div>
                </div>
              </article>
            </Reveal>
