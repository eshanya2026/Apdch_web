...
export default function WhyChooseAPDCH() {
  return (
    <section id="why-apdch" className="mesh-bg px-5 py-24 md:px-8 md:py-32">
      <div className="mx-auto max-w-7xl">
        <Reveal>
          <SectionHeading
            eyebrow={WHY_CHOOSE_ADMISSIONS_SECTION.eyebrow}
            title={WHY_CHOOSE_ADMISSIONS_SECTION.title}
            description={WHY_CHOOSE_ADMISSIONS_SECTION.description}
          />
        </Reveal>
