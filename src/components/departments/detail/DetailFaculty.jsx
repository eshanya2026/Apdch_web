  ...
  return (
    <section className="mesh-bg px-5 py-24 md:px-8 md:py-28">
      <div className="mx-auto max-w-7xl">
        ...
        {hod && (
          <Reveal delay={0.05}>
            <article className="mt-12 overflow-hidden rounded-[1.75rem] border border-border/80 bg-white shadow-brand-card lg:grid lg:grid-cols-[0.85fr_1.15fr]">
        ...
        {members.length > 0 && (
          <>
            <Reveal delay={0.08}>
              <h3 className="mt-12 text-lg font-semibold tracking-tight text-foreground md:text-xl">
                Faculty Members
              </h3>
            </Reveal>
